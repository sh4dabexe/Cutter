Create a URL shortner website
first crete a implementation plan


giving a you sa prompt of website UI

adjust my web requirements according to the command
...
for storing all shorted links i'm adding supabase api and keys url


also build a login page with where google auth and normal email id registration should also available
i'll connect through supabase all these stuff
